...
def _get_daily_metrics(bucket: str, start_date: str, end_date: str) -> dict[str, Any]:
...
def _get_monthly_metrics(bucket: str, start_date: str, end_date: str) -> dict[str, Any]:
