...
- **[Blueprint QA workflow](docs/documentai-api/blueprint-qa-workflow.md)** - repeatable process for adding/configuring blueprints, QA-ing them with synthetic documents, and building a reusable reference library
