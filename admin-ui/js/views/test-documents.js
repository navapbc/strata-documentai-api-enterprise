...
export function mount(root) {
  ...
  _tenantSelect = h("select", { className: "tenant-select", id: "test-tenant-select" }, h("option", { value: "" }, "— Select tenant —"));
  _categorySelect = h("select", { className: "tenant-select", id: "test-category-select" }, h("option", { value: "" }, "— Select category —"));
  _fileInput = h("input", { type: "file", id: "test-file-input", accept: ".pdf,.png,.jpg,.jpeg,.tiff,.tif" });
